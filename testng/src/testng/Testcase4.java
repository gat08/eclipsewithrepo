...
public class Testcase4 {
	...
	public void check26(){
		...
		driver.close();
		AssertJUnit.assertEquals(person, "Name");
	}
	@Test
	public void check27(){
		System.setProperty("webdriver.chrome. driver", "chromedriver.exe");
		...
		driver.close();
		AssertJUnit.assertEquals(common, "similar");
	}
	@Test
	public void check28(){
		System.setProperty("webdriver,chrome.driver", "chromedriver.exe");
		...
		driver.close();
		AssertJUnit.assertEquals(source, "Official Source");
	}
	@Test
	public void check29(){
		System.setProperty("webdriver,chrome.driver", "chromedriver.exe");
		...
		driver.close();
		AssertJUnit.assertEquals(dor, "Vendor");
	...
	public void check30(){
		...
		driver.close();
		AssertJUnit.assertEquals(bit, "32bit");
	}
