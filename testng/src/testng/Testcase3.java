...
public void check21(){
	...
	driver.get("file:///C:/Users/MayT/Downloads/javabykiran-Selenium-Softwares/javabykiran-Selenium-Softwares/Offline%20Website/pages/examples/links.html");
	String srno = driver.findElement(By.xpath("/html/body/div/div[1]/section[2]/div/div/div/div[2]/table/tbody/tr[1]/th[1]")).getText();
	driver.close();
	AssertJUnit.assertEquals(srno, "Sr");
}
@Test
public void check22(){
	System.setProperty("webdriver,chrome,driver", "chromedriver.exe");
	...
	driver.close();
	AssertJUnit.assertEquals(content, "CONTENT");
}
@Test
public void check23(){
	System.setProperty("webdriver,chrome.driver", "chromedriver.exe");
	...
	driver.close();
	AssertJUnit.assertEquals(click, "click");
}
@Test
public void vcheck24(){
	...
	driver.close();
	AssertJUnit.assertEquals(links, "Useful Links");
}
@Test
public void check25(){
	System.setProperty("webdriver,chrome.driver", "chromedriver.exe");
	...
	driver.close();
	AssertJUnit.assertEquals(out, "Logout");
}
